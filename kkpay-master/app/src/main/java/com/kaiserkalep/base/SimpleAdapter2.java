...
public abstract class SimpleAdapter2<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public SimpleAdapter2(Context context, List<T> mData, int itemLayoutId) {
    ...
    public SimpleAdapter2(Context context, List<T> mData, int itemLayoutId, OnItemClickListener listener) {
        this.mContext = context;
        this.mInflater = LayoutInflater.from(mContext);
        this.mData = mData;
        this.mItemLayoutId = itemLayoutId;
