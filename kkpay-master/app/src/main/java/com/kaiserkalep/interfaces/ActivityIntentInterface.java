...
public interface ActivityIntentInterface extends IBaseView {
     ...
     * @return 是否登录
     */
    void checkLogin(String activityName, HashMap params);
    ...
    void checkLogin(int activityName);

    void checkLogin(int activityName, HashMap params);
     ...
     * @param id  广告id
     */
    void advertTracker(String url, String id);
}
