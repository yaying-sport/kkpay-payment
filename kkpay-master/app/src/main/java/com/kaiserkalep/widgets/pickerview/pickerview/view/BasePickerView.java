package com.kaiserkalep.widgets.pickerview.pickerview.view;
...
import com.kaiserkalep.widgets.pickerview.PickerViewDialog;
import com.kaiserkalep.widgets.pickerview.pickerview.configure.PickerOptions;
import com.kaiserkalep.widgets.pickerview.pickerview.listener.OnDismissListener;
import com.kaiserkalep.widgets.pickerview.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    private DialogCommBase mDialog;
...
//            params.rightMargin = 30;
    ...
    private Animation getInAnimation() {
        int res = PickerViewAnimateUtil.getAnimationResource(mPickerOptions.animGravity, true);
        return AnimationUtils.loadAnimation(context, res);
    }

    private Animation getOutAnimation() {
        int res = PickerViewAnimateUtil.getAnimationResource(mPickerOptions.animGravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new PickerViewDialog(context);
    ...
    public DialogCommBase getDialog() {
        return mDialog;
    }
