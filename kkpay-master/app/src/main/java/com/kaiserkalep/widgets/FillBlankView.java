...
public class FillBlankView extends AppCompatEditText {
    ...
    private AddTextChangedListener mTextListener;
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() > mBlankNum) {
                    ...
                    if (null != mTextListener) {
                        mTextListener.onTextLengthChanged(mDotCount);
                    }
                    return;
                }
                ...
                int length = s.length();
                if (null != mTextListener) {
                    mTextListener.onTextLengthChanged(length);
                }
...
//        super.draw(canvas);
    ...
    public AddTextChangedListener getAddTextChangedListener() {
        return mTextListener;
    }

    public void setOnTextChangedListener(AddTextChangedListener mTextListener) {
