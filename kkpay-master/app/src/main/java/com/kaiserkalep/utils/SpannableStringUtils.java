...
public class SpannableStringUtils {
    ...
    public void addText(int textSize, int textColor, String textStr, ShowAllSpan.OnAllSpanClickListener listener) {
        if (CommonUtils.StringNotNull(textStr)) {
            ...
            if (listener != null) {
                ShowAllSpan showAllSpan = new ShowAllSpan(MyApp.getContext(), listener);
    ...
    public void addBackgroundShape(int bgColor, int textColor, int mSize, int radius, String textStr, boolean isCurrent) {
        if (CommonUtils.StringNotNull(textStr)) {
            RoundBackgroundColorSpan span = new RoundBackgroundColorSpan(bgColor, textColor
                    , UIUtils.dip2px(ClientInfo.scale, mSize), UIUtils.dip2px(ClientInfo.scale, radius), isCurrent);
