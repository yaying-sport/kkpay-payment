package com.kaiserkalep.utils.skinlibrary.loader;
...
import com.kaiserkalep.utils.skinlibrary.SkinItem;
...
public class SkinInflaterFactory implements LayoutInflater.Factory2 {
    ...
    private void parseSkinAttr(Context context, AttributeSet attrs, View view) {
        ...
        for (int i = 0; i < attrs.getAttributeCount(); i++) {
            ...
            if ("style".equals(attrName)) {
                ...
                if (textColorId != -1) {
                    ...
                    SkinAttr skinAttr = AttrFactory.get(AttrFactory.textColor, textColorId, entryName, typeName);
                ...
                if (backgroundId != -1) {
                    ...
                    SkinAttr skinAttr = AttrFactory.get(AttrFactory.background, backgroundId, entryName, typeName);
        ...
        if (!SkinListUtils.isEmpty(viewAttrs) && mSkinItemMap != null) {
    ...
    public void applySkin() {
        if (mSkinItemMap == null || mSkinItemMap.isEmpty()) {
            return;
        }
