...
final class WindowHelper implements Application.ActivityLifecycleCallbacks {
    ...
    private WindowHelper(com.kaiserkalep.utils.toast.ToastHelper toast) {
        mToastHelper = toast;
    }

    static WindowHelper register(com.kaiserkalep.utils.toast.ToastHelper toast, Application application) {
