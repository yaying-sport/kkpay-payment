...
public class RSA {
	...
	public static Map<String, String> generateKeyPair() throws Exception {
		...
		String pub = new String(MyBase64.encodeBase64(publicKeyBytes),
				ConfigureEncryptAndDecrypt.CHAR_ENCODING);
		/** 得到私钥 */
		Key privateKey = kp.getPrivate();
		byte[] privateKeyBytes = privateKey.getEncoded();
		String pri = new String(MyBase64.encodeBase64(privateKeyBytes),
				ConfigureEncryptAndDecrypt.CHAR_ENCODING);
		...
		byte[] deBase64Value = MyBase64.encodeBase64(b);
	...
	public static String encrypt(String source, String publicKey)
		...
		return new String(MyBase64.encodeBase64(b1),
				ConfigureEncryptAndDecrypt.CHAR_ENCODING);
	}
	...
	public static String decrypt(String cryptograph, String privateKey)
		...
		byte[] b1 = MyBase64.decodeBase64(cryptograph.getBytes());
		/** 执行解密操作 */
	...
	public static PublicKey getPublicKey(String key) throws Exception {
		X509EncodedKeySpec keySpec = new X509EncodedKeySpec(
				MyBase64.decodeBase64(key.getBytes()));
	...
	public static String sign(String content, String privateKey) {
		...
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(
					MyBase64.decodeBase64(privateKey.getBytes()));
			...
			return new String(MyBase64.encodeBase64(signed));
		} catch (Exception e) {
	...
	public static boolean checkSign(String content, String sign, String publicKey)
	{
		...
		{
			KeyFactory keyFactory = KeyFactory.getInstance("RSA");
	        byte[] encodedKey = MyBase64.decode2(publicKey);
			...
			boolean bverify = signature.verify( MyBase64.decode2(sign) );
			return bverify;
