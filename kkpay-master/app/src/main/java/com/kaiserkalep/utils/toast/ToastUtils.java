package com.kaiserkalep.utils.toast;
...
import com.kaiserkalep.utils.toast.style.ToastQQStyle;
import com.kaiserkalep.utils.toast.style.ToastWhiteStyle;
...
public final class ToastUtils {
    ...
    public static void init(Application application) {
        ...
        if (isNotificationEnabled(application)) {
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.N_MR1) {
                ...
                setToast(new com.kaiserkalep.utils.toast.SafeToast(application));
            } else {
                setToast(new com.kaiserkalep.utils.toast.BaseToast(application));
            }
        } else {
     ...
     * @param text 需要显示的文本
     */
    public static synchronized void showLong(CharSequence text) {
        showLong(text, IToastStrategy.SHORT_DURATION_TIMEOUT);
    }
     ...
     * @param text 需要显示的文本
     */
    public static synchronized void showLong(CharSequence text, long time) {
        checkToastState();
    ...
    private static TextView createTextView(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            textView.setPaddingRelative(sStyle.getpaddingLeft(), sStyle.getPaddingTop(), sStyle.getPaddingEnd(), sStyle.getPaddingBottom());
        } else {
            textView.setPadding(sStyle.getpaddingLeft(), sStyle.getPaddingTop(), sStyle.getPaddingEnd(), sStyle.getPaddingBottom());
        }
