...
public class StringUtils {
    ...
    public static void main(String[] a) {
        ...
        String s2 = "vivo 1816";
        String s3 = "华为 P30";
        String s4 = " sadfghjk30";
        String s5 = " 时代的步伐";

        System.out.print(chinaToUnicode(s) + "\n");
        System.out.print(chinaToUnicode(s2) + "\n");
        System.out.print(chinaToUnicode(s3) + "\n");
        System.out.print(chinaToUnicode(s4) + "\n");
        System.out.print(chinaToUnicode(s5) + "\n");
    }
}
