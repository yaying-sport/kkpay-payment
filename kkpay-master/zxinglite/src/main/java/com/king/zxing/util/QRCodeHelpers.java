...
public class QRCodeHelpers {
     ...
     */
    private static String syncDecodeQRCode(String picturePath) {
    ...
    public static class QrCodeAsyncTask extends AsyncTask<String, Integer, String> {
        private QrReadPhotoCallBackListener listener;
        private String path;

        public QrCodeAsyncTask(String path, QrReadPhotoCallBackListener listener) {
        ...
        protected String doInBackground(String... strings) {
            // 解析二维码/条码
            return QRCodeHelpers.syncDecodeQRCode(path);
        }
