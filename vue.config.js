...
const name = process.env.VUE_APP_TITLE || 'KKPAY商户管理系统' // 网页标题
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        target: `http://payproxy.tw00.cc/`,
        // target: `https://m.kkpay11.com/`,
        changeOrigin: true,
        pathRewrite: {
      ...
      "/s3": {
        // target: "http://pcpre.tw00.cc",
        target: "http://payproxy.tw00.cc/", //测试环境
        // target: `https://m.kkpay11.com/`,
        changeOrigin: true,
        // secure: false,
        pathRewrite: {
